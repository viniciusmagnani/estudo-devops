...
$ ssh -i 192.168.14.35 	- RancherServer - HOST A
$ ssh -i 192.168.14.49  - k8s-1         - HOST B
$ ssh -i 192.168.14.50  - k8s-2         - HOST C
$ ssh -i 192.168.14.51 	- k8s-3         - HOST D
...
$ curl -L "https://github.com/docker/compose/releases/download/v2.5.1/docker-compose-linux-aarch64-$(uname -s)-$(uname -m)" -o /usr/local/bin/docker-compose
